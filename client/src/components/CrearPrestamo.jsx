...
const CrearPrestamo = ({ updateCuotas }) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:80/api/cliente")
      .then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:80/api/prestamo", prestamos)
      .then((res) => {
        ...
        <div className="row align-items-center mt-3">
          <div className="col-auto">
            ...
            <input
              ...
              id="monto"
              name="monto"
              value={prestamos.monto}
              onChange={handleChange}
            />
          </div>
          <div className="col-auto">
            <label className="me-3" htmlFor="fechaPrestamo">
              Fecha de préstamo:{" "}
            </label>
            <DatePicker
